...
static void broadcastProperties(BatteryProperties* oldprops, const BatteryProperties props) {
    ...
    if (oldprops->chargerAcOnline != props.chargerAcOnline) {
        if (property_set("sys.healthd.charger_ac_online", propToString(props.chargerAcOnline, str)) < 0)
    ...
    if (oldprops->chargerUsbOnline != props.chargerUsbOnline) {
        if (property_set("sys.healthd.charger_usb_online", propToString(props.chargerUsbOnline, str)) < 0)
    ...
    if (oldprops->chargerWirelessOnline != props.chargerWirelessOnline) {
        if (property_set("sys.healthd.charger_wireless_online", propToString(props.chargerWirelessOnline, str)) < 0)
